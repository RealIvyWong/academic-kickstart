...
- icon: envelope
  icon_pack: fas
  link: 'mailto:huangyingjing@whu.edu.cn'  # For a direct email link, use "mailto:test@example.org".
- icon: blog
  icon_pack: fas
  link: http://www.cnblogs.com/IvyWong/
- icon: github
  icon_pack: fab
  link: https://github.com/realivywong
- icon: researchgate
  icon_pack: ai
  link: https://www.researchgate.net/profile/Yingjing_Huang
